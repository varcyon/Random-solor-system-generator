...
public abstract class CelestialBody : MonoBehaviour {
    ...
    //isLoading is for checking if we are loading a saved system
    ...
    //Adds all possible elements to the star or planet
    ...
    //Creates the star / planetary object
    ...
    //retrieve the diameter of the object
    ...
    // Tooltip generator hover mouse over the object
